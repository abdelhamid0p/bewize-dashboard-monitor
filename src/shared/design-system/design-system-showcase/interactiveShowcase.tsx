...
import { ICONS, type IconName } from '@/shared/components/atoms/icon/iconName.ts';
import {Link} from "react-router-dom";

const InteractiveShowcase = () => {
    const [selectedVariant, setSelectedVariant] = useState<'default' | 'secondary'>('default');
    const [selectedIcon, setSelectedIcon] = useState<IconName | undefined>(ICONS.upload);
    ...
    return (
        <div className="min-h-screen bg-neutral-100">
            ...
            <header className="bg-white border-b border-neutral-200 px-8 py-6">
                ...
                <h1 className="text-2xl font-semibold text-neutral-900">Design System Showcase</h1>
                <p className="text-sm text-neutral-600 mt-1">Visualisation interactive des composants</p>
            </header>
                ...
                <section className="mb-12 max-w-6xl mx-auto">
                    <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
                        <div className="border-b border-neutral-200 px-8 py-4 bg-neutral-50">
                            <h2 className="text-lg font-semibold text-neutral-900">Button Playground</h2>
                        </div>

                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
                            {/* Preview */}
                            <div className="flex flex-col">
                                <h3 className="text-sm font-medium text-neutral-700 mb-4">Aperçu</h3>
                            ...
                            <div className="flex flex-col space-y-6">
                                <h3 className="text-sm font-medium text-neutral-700">Contrôles</h3>

                                {/* Text Input */}
                                <div>
                                    <label className="block text-sm text-neutral-600 mb-2">Texte</label>
                                    <input
                                        type="text"
                                        value={buttonText}
                                ...
                                {/* Variant Select */}
                                <div>
                                    <label className="block text-sm text-neutral-600 mb-2">Variant</label>
                                ...
                                {/* Icon Select */}
                                <div>
                                    <label className="block text-sm text-neutral-600 mb-2">Icône</label>
                                ...
                                {selectedIcon && (
                                    <div>
                                        <label className="block text-sm text-neutral-600 mb-2">Position de l'icône</label>
                                        <div className="flex gap-2">
                                            <button
                                ...
                                {/* Code Preview */}
                                <div>
                                    <label className="block text-sm text-neutral-600 mb-2">Code</label>
  ...
  ${buttonText}
                ...
                <section className="mb-12 max-w-6xl mx-auto">
                    <div className="bg-white rounded-2xl shadow-sm p-8">
                        <h2 className="text-lg font-semibold text-neutral-900 mb-6">Toutes les variantes</h2>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            {/* Primary */}
                            <div className="space-y-4">
                                <h3 className="text-sm font-medium text-neutral-700">Primary Button</h3>
                                <div className="space-y-3 p-6 bg-neutral-50 rounded-xl">
                                    <Button variant="default">Sans icône</Button>
                                    <Button variant="default" icon={ICONS.upload}>Avec icône gauche</Button>
                                    <Button variant="default" icon={ICONS.chevronDown} iconPosition="right">
                                        Avec icône droite
                                    </Button>
                            ...
                            {/* Secondary */}
                            <div className="space-y-4">
                                <h3 className="text-sm font-medium text-neutral-700">Secondary Button</h3>
                                <div className="space-y-3 p-6 bg-neutral-50 rounded-xl">
                                    <Button variant="secondary">Sans icône</Button>
                                    <Button variant="secondary" icon={ICONS.users}>Avec icône gauche</Button>
                                    <Button variant="secondary" icon={ICONS.chevronDown} iconPosition="right">
                                        Avec icône droite
                                    </Button>
                ...
                <section className="max-w-6xl mx-auto">
                    <div className="bg-white rounded-2xl shadow-sm p-8">
                        <h2 className="text-lg font-semibold text-neutral-900 mb-6">Bibliothèque d'icônes</h2>
