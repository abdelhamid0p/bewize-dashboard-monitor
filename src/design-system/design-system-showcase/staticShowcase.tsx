        ...
        <div className="mb-12 bg-white rounded-2xl p-8 shadow-sm">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <Button variant="default" icon={ICONS.upload} iconPosition="left">
                Primary button
              </Button>
            </div>
      ...
      <section className="mb-16 max-w-4xl">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm">
          <p className="text-sm text-neutral-600 mb-6 max-w-xl">
            ...
            filter is inactive, it appears in gray, indicating that it is not
            selected. This visual distinction improves clarity, usability, and
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="flex gap-3 flex-wrap">
                ...
                <Button variant="default" className="w-auto px-6">
                  Créer un abonnement
                </Button>
              </div>
            </div>
