...
export const DashboardPage = () => {
  ...
  return (
    <div className="p-3 lg:p-4 xl:p-6">
      ...
      {/* Number Cards */}
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3 lg:gap-4 xl:gap-6 mt-4 lg:mt-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-3 lg:gap-4 xl:gap-6 mt-4 lg:mt-6">
